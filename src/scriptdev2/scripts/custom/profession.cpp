...
bool GossipHello_Npc_Profession(Player* player, Creature* m_creature)
{
    ...
    else if (player->HasSkill(SKILL_BLACKSMITHING)) // 164
    ...
    else if (player->HasSkill(SKILL_ENCHANTING)) // 333
    ...
    else if(player->HasSkill(SKILL_ENGINEERING)) // 202
    ...
    else if(player->HasSkill(SKILL_HERBALISM)) // 182
    ...
    else if(player->HasSkill(SKILL_JEWELCRAFTING)) // 755
    ...
    else if(player->HasSkill(SKILL_LEATHERWORKING)) //165 
...
bool GossipSelect_Npc_Profession(Player* player, Creature* m_creature, uint32 /*sender*/, uint32 action)
{
    ...
    switch (action)
    {
        // Alchemy
    case 100:
        if (player->GetBaseSkillValue(171) >= 1)
        {
        ...
        // Blacksmithing
    case 200:
        if (player->GetBaseSkillValue(164) >= 1)
        {
        ...
        // Enchanting
    case 300:
        if (player->GetBaseSkillValue(333) >= 1)
        {
        ...
        // Engineering
    case 400:
        if (player->GetBaseSkillValue(202) >= 1)
        {
        ...
        // Herbalism
    case 500:
        if (player->GetBaseSkillValue(182) >= 1)
        {
        ...
        // Jewelcrafting
    case 600:
        if (player->GetBaseSkillValue(755) >= 1)
        {
        ...
        // Leatherworking
    case 700:
        if (player->GetBaseSkillValue(165) >= 1)
        {
        ...
        // Mining
    case 800:
        if (player->GetBaseSkillValue(186) >= 1)
        {
        ...
        // Skinning
    case 900:
        if (player->GetBaseSkillValue(393) >= 1)
        {
        ...
        // Tailoring
    case 1000:
        if (player->GetBaseSkillValue(197) >= 1)
        {
